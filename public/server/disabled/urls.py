...
urlpatterns = [
    ...
    path("addcounciling",views.add_counciling,name="add_counciling"),
    path("editcounciling/<int:id>",views.admin_editcounciling,name="admin_editcounciling"),
    path("updatecounciling/<int:id>",views.admin_updatecounciling,name="admin_updatecounciling"),
    path("deletecounciling/<int:id>",views.admin_deletecounciling,name="admin_deletecounciling"),
    path("viewcounciling",views.admin_viewcounciling,name="admin_viewcounciling"),
