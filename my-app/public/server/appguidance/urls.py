...
urlpatterns = [
        ...
        # path("order",views.orderSerializersAPIView.as_view(),name="order"), 
        # path("order_price",views.cartSerializerAPIView.as_view(),name="order_price"), 
        ...
        # path("cartDecrementQuantity",views.cartDecrementQuantityAPIView.as_view(),name="cartDecrementQuantity"), 
