    ...
    <div className="navbar-nav mr-auto py-0">
      ...
      {/* <div className="nav-item dropdown"> */}
        ...
        <div className="dropdown-menu rounded-0 m-0">
          ...
          <a href="/Shoporderview" className="nav-item nav-link">
        order
      </a>
      ...
      <a href="/Addproduct" className="nav-item nav-link">
        Add product
      </a>
      <a href="/Notification" className="nav-item nav-link">
        Notification
      </a>
